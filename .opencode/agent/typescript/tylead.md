...
description: >-
  ...
  right implementor - Tyson for backend, Nova for frontend. Returns research
  findings that flow naturally into implementation plans with file:line refs.
mode: subagent
temperature: 0.2
tools:
  read: true
...
7. Create a plan in markdown file and save the plan to .kilo/plans, if path not exists, create one
